import{n as Xe}from"./calendar-utils.js";const p=document.getElementById("public-booking-root"),ze={first_name:"First name",last_name:"Last name",email:"Email address",phone:"Phone number",address:"Address",notes:"Notes"};p?Je():console.warn("[public-booking] Root element not found.");function Je(){var Z;const g=Me(),P=new Date,$=g.initialAvailability??null,x=g.initialCalendar??null,A=Array.isArray(x==null?void 0:x.availableDates)?x.availableDates:[],ne=(x==null?void 0:x.defaultDate)??A[0]??null,w=($==null?void 0:$.date)??ne??P.toISOString().slice(0,10),le=((Z=x==null?void 0:x.slotsByDate)==null?void 0:Z[w])??[],ae=A.length>0&&le.length>0;let f={view:"book",booking:G(g,w,$,x),manage:Q(g,w),csrf:{header:p.dataset.csrfHeader||"X-CSRF-TOKEN",value:p.dataset.csrfValue||"",name:p.dataset.csrfName||"csrf_token"}};B(),f.booking.providerId&&f.booking.serviceId&&(ae?U("booking"):C("booking"));function S(e){const t=We();f=typeof e=="function"?e(He(f)):{...f,...e},B(),Ve(t)}function q(e){S(t=>({...t,booking:typeof e=="function"?e(t.booking):{...t.booking,...e}}))}function y(e){S(t=>({...t,manage:typeof e=="function"?e(t.manage):{...t.manage,...e}}))}function N(e){S(t=>({...t,manage:{...t.manage,formState:typeof e=="function"?e(t.manage.formState):{...t.manage.formState,...e}}}))}function E(e){return e==="manage"?f.manage.formState:f.booking}function m(e,t){if(e==="manage"){N(t);return}q(t)}function B(){const e=$e(g),t=we(f.view),o=f.view==="book"?f.booking.success?W(f.booking.success,g):H(f.booking,g):Ee(f.manage,g);p.innerHTML=`
    ...
    `}function Se(e,t){const s=H(e.formState,t,{formId:"public-reschedule-form",actionOptions:{submitLabel:"Save new time",pendingLabel:"Updating booking...",helperText:"We will send your updated confirmation immediately after you save."}});return`
      <div class="space-y-6">
        ${De(e,t)}
        ${s}
      </div>
    `}function De(e,t){var a,d,b,h;const o=e.appointment;if(!o)return"";const s=X(o,t),r=z(o,t),n=V(o),l=((a=e.contact)==null?void 0:a.email)||((d=o.customer)==null?void 0:d.email),i=((b=e.contact)==null?void 0:b.phone)||((h=o.customer)==null?void 0:h.phone),u=l?`Verified via <span class="font-semibold">${c(l)}</span>`:i?`Verified via <span class="font-semibold">${c(i)}</span>`:"Contact verified";return`
      <section class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
    ...
    `}function Te(e){const t=e.reschedulePolicy??{enabled:!0,label:"24 hours"};return`<p class="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600">${t.enabled?`Need to make a change? You can reschedule online up to ${c(t.label??"24 hours")} before your appointment.`:"Contact the office directly if you need to make a change."}</p>`}function je(e,t={}){const o=(t==null?void 0:t.submitLabel)??"Confirm appointment",s=(t==null?void 0:t.pendingLabel)??"Booking your appointment...",r=(t==null?void 0:t.helperText)??"We respect your privacy. Your confirmation token will be displayed and emailed immediately.",n=e.submitting?"disabled":"",l=e.submitting?s:o;return`
    ...
    `}function Ae(e,t,o){const s=t.label??ze[e]??e,r=t.required;return`
      <label class="block text-sm font-medium text-slate-700">
