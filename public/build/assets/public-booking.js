const b=document.getElementById("public-booking-root"),$e={first_name:"First name",last_name:"Last name",email:"Email address",phone:"Phone number",address:"Address",notes:"Notes"};b?we():console.warn("[public-booking] Root element not found.");function we(){const p=ve(),h=new Date().toISOString().slice(0,10);let u={view:"book",booking:R(p,h),manage:U(p,h),csrf:{header:b.dataset.csrfHeader||"X-CSRF-TOKEN",value:b.dataset.csrfValue||"",name:b.dataset.csrfName||"csrf_token"}};P(),u.booking.providerId&&u.booking.serviceId&&y("booking");function $(e){const t=ke();u=typeof e=="function"?e(he(u)):{...u,...e},P(),ye(t)}function E(e){$(t=>({...t,booking:typeof e=="function"?e(t.booking):{...t.booking,...e}}))}function v(e){$(t=>({...t,manage:typeof e=="function"?e(t.manage):{...t.manage,...e}}))}function S(e){$(t=>({...t,manage:{...t.manage,formState:typeof e=="function"?e(t.manage.formState):{...t.manage.formState,...e}}}))}function L(e){return e==="manage"?u.manage.formState:u.booking}function m(e,t){if(e==="manage"){S(t);return}E(t)}function P(){const e=oe(p),t=se(u.view),o=u.view==="book"?u.booking.success?A(u.booking.success,p):j(u.booking,p):re(u.manage,p);b.innerHTML=`
    ...
    `}function ie(e,t){var a,c,x,k;const o=e.appointment;if(!o)return"";const n=O(o,t),s=M(o,t),r=T(o),l=((a=e.contact)==null?void 0:a.email)||((c=o.customer)==null?void 0:c.email),d=((x=e.contact)==null?void 0:x.phone)||((k=o.customer)==null?void 0:k.phone),f=l?`Verified via <span class="font-semibold">${i(l)}</span>`:d?`Verified via <span class="font-semibold">${i(d)}</span>`:"Contact verified";return`
      <section class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
    ...
    `}function pe(e,t,o){const n=t.label??$e[e]??e,s=t.required;return`
      <label class="block text-sm font-medium text-slate-700">
    ...
    `}function g(e,t){return!t||!t[e]?"":`<p class="mt-1 text-sm text-red-600">${i(t[e])}</p>`}function xe(e){const t=e!=null&&e.start?new Date(e.start):null,o=e!=null&&e.end?new Date(e.end):null;if(!t||!o)return"Selected time";const n=new Intl.DateTimeFormat(void 0,{hour:"numeric",minute:"2-digit"});return`${n.format(t)} - ${n.format(o)}`}function C(e){if(!(e!=null&&e.start))return"";const t=new Date(e.start),o=e.end?new Date(e.end):null,n=new Intl.DateTimeFormat(void 0,{weekday:"short",month:"short",day:"numeric"}),s=new Intl.DateTimeFormat(void 0,{hour:"numeric",minute:"2-digit"}),r=n.format(t),l=o?`${s.format(t)} - ${s.format(o)}`:s.format(t);return`${r}, ${l}`}function T(e){return e?e.display_range?e.display_range:C({start:e.start,end:e.end}):""}function O(e,t){var n;if((n=e==null?void 0:e.provider)!=null&&n.name)return e.provider.name;const o=(t.providers??[]).find(s=>Number(s.id)===Number(e==null?void 0:e.provider_id));return(o==null?void 0:o.name)??(o==null?void 0:o.displayName)??"Assigned provider"}function M(e,t){var n;if((n=e==null?void 0:e.service)!=null&&n.name)return e.service.name;const o=(t.services??[]).find(s=>Number(s.id)===Number(e==null?void 0:e.service_id));return(o==null?void 0:o.name)??"Selected service"}function ve(){try{return JSON.parse(b.dataset.context??"{}")||window.__PUBLIC_BOOKING__||{}}catch(e){return console.error("[public-booking] Failed to parse context payload.",e),window.__PUBLIC_BOOKING__||{}}}function B(e){const t={first_name:"",last_name:"",email:"",phone:"",address:"",notes:""},o=e.fieldConfig??{};Object.keys(o).forEach(s=>{t[s]===void 0&&(t[s]="")});const n=e.customFieldConfig??{};return Object.keys(n).forEach(s=>{t[s]=n[s].type==="checkbox"?"0":""}),t}function R(e,t){var o,n,s,r,l,d;return{providerId:((s=(n=(o=e.providers)==null?void 0:o[0])==null?void 0:n.id)==null?void 0:s.toString())??"",serviceId:((d=(l=(r=e.services)==null?void 0:r[0])==null?void 0:l.id)==null?void 0:d.toString())??"",appointmentDate:t,slots:[],slotsLoading:!1,slotsError:"",selectedSlot:null,form:B(e),errors:{},globalError:"",submitting:!1,success:null}}function U(e,t){return{stage:"lookup",lookupForm:{token:"",email:"",phone:""},lookupErrors:{},lookupError:"",lookupLoading:!1,appointment:null,success:null,contact:{email:"",phone:""},formState:{providerId:"",serviceId:"",appointmentDate:t,slots:[],slotsLoading:!1,slotsError:"",selectedSlot:null,form:B(e),errors:{},globalError:"",submitting:!1}}}async function _(e){try{return await e.json()}catch{return null}}function he(e){return typeof structuredClone=="function"?structuredClone(e):JSON.parse(JSON.stringify(e))}function ke(){const e=document.activeElement;return!e||!b.contains(e)?null:e instanceof HTMLInputElement||e instanceof HTMLTextAreaElement?{name:e.name||null,selectionStart:e.selectionStart,selectionEnd:e.selectionEnd}:null}function ye(e){if(!(e!=null&&e.name))return;const t=`input[name="${e.name}"]`,o=b.querySelector(t)||b.querySelector(`textarea[name="${e.name}"]`);if((o instanceof HTMLInputElement||o instanceof HTMLTextAreaElement)&&(o.focus({preventScroll:!0}),typeof e.selectionStart=="number"&&typeof e.selectionEnd=="number"))try{o.setSelectionRange(e.selectionStart,e.selectionEnd)}catch{}}}class w extends Error{constructor(F,h={}){super(F),this.details=h}}function i(p){return p==null?"":String(p).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}
