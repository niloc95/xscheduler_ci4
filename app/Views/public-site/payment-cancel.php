...
<head>
    ...
    <title>Payment Cancelled — WebScheduler</title>
...
<body>
    <div class="card">
        ...
        <p>Your payment was not completed. Your booking slot has been reserved but is pending payment.</p>
        <p>You can retry the payment or contact us to arrange an alternative.</p>
        <a class="back" href="<?= base_url('booking') ?>">← Return to booking</a>
    </div>
</body>
</html>
