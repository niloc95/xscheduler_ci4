            ...
            <div class="flex items-center justify-between p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                <div class="flex items-center gap-4">
                    <div class="text-center min-w-[60px]">
                        <div class="text-sm font-semibold text-blue-600"><?= date('M', utc_to_local($appt['start_at'])) ?></div>
                        <div class="text-2xl font-bold text-gray-800 dark:text-gray-200"><?= date('j', utc_to_local($appt['start_at'])) ?></div>
                    </div>
                    <div>
                        <div class="font-medium text-gray-800 dark:text-gray-200"><?= esc($appt['service_name'] ?? 'Service') ?></div>
                        <div class="text-sm text-gray-600 dark:text-gray-400">
                            <?= date('l \a\t g:i A', utc_to_local($appt['start_at'])) ?>
                        ...
                        <td class="px-4 py-3">
                            ...
                            <div class="text-xs text-gray-500 dark:text-gray-400">
                                ...
                                <?php if (!empty($appt['end_at'])): ?>
                                    - <?= date('g:i A', utc_to_local($appt['end_at'])) ?>
                                <?php endif; ?>
                            </div>
                        </td>
                        <td class="px-4 py-3">
