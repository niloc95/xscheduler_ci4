...
<!-- Sidebar -->
<div id="sidebar" class="sidebar fixed top-0 left-0 z-40 w-64 h-screen">
    <div class="h-full px-3 py-4 overflow-y-auto">
        <!-- Logo -->
        <div class="flex items-center justify-between mb-6 p-2">
            <div class="flex items-center">
                <md-icon-button class="text-blue-400">
                    <md-icon>schedule</md-icon>
                </md-icon-button>
                <span class="text-xl font-semibold text-white ml-2">xScheduler</span>
            </div>
