            ...
            <section id="panel-general" class="tab-panel">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="form-field">
                        ...
                        <div class="md:flex md:items-center md:gap-4">
                            <div class="md:flex-1">
                                <input id="company_icon" type="file" name="company_icon" accept="image/x-icon,image/png,image/svg+xml,.ico" class="form-input file-input" />
                ...
                <div class="flex justify-end mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                    <button id="save-general-btn" type="submit" class="btn-submit">
