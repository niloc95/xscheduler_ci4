...
<div class="main-content" data-page-title="Edit Customer">
	...
	<div class="p-4 md:p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm">
		<form method="post" action="<?= base_url('user-management/update/' . ($customer['id'] ?? 0)) ?>" class="space-y-6">
			<?= csrf_field() ?>
			...
			<div class="flex gap-3">
				...
				<a href="<?= base_url('user-management') ?>" class="inline-flex items-center gap-2 px-4 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600">Cancel</a>
			</div>
		</form>
	</div>
</div>
