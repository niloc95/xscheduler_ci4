...
### Added
- feat: mobile-first dashboard & appointment scheduler redesign
...
### Changed
- ci: commit generated docs index directly instead of opening a PR

### Fixed
- fix: responsive header toolbar, temporal pill, and tablet sidebar rail
...
### Fixed
- fix: live-sync sidebar logo/favicon and currency after settings save
...
### Fixed
- fix: Mark as Received button stuck on Saving — wrong apiRequest signature

## [2.0.19] - 2026-06-08

### Added
- feat: admin "Mark as Received" button for manual deposit collection
...
### Changed
- docs: add UPDATER.md and update operations skill (items 52–56)

### Fixed
- fix: prevent admin lockout when inactivity timer fires during maintenance mode
...
### Fixed
- fix: use CI4-standard RewriteRule in generated .htaccess
...
### Fixed
- fix: detect GitHub source archive and show actionable error message
...
[2.0.10]: https://github.com/niloc95/xscheduler_ci4/compare/v2.0.9...v2.0.10
[2.0.11]: https://github.com/niloc95/xscheduler_ci4/compare/v2.0.10...v2.0.11
