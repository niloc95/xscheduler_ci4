...
| ID | File | Issue |
|----|------|-------|
| F-3 | Removed in 2026-03 cleanup | Former `app/Views/styleguide/index.php` listener stacking issue is no longer actionable because the Styleguide surface was deleted. |
| F-4 | Removed in 2026-03 cleanup | Former `app/Views/styleguide/components.php` listener stacking issue is no longer actionable because the Styleguide surface was deleted. |
